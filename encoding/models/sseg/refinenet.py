...
def get_refinenet(dataset='nyud', backbone='resnet34', pretrained=True, root='./encoding/models/pretrain', n_features=256):
    from ...datasets import datasets
    model = RefineNet(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, pretrained=pretrained, root=root, n_features=n_features)
    return model
