...
CONFIG_PATH = os.path.join(BASE_DIR, 'results/danet_dep_resnet50/config.yaml')
...
class Trainer():
    def __init__(self, args):
        ...
        params_list = [{'params': model.pretrained.parameters(), 'lr': args.lr},
                       {'params': model.dep_encoder.parameters(), 'lr': args.lr},
                       {'params': model.dep_layer0.parameters(), 'lr': args.lr*10}]
