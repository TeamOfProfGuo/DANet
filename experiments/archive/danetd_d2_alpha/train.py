...
class Trainer():
    def __init__(self, args):
        ...
        model = get_segmentation_model(args.model, dataset=args.dataset,
                                       ...
                                       dep_main = True,    # use depth as primary input
                                       dep_encode='dep',   # use depth feature directly
                                       fuse_type='a',      # add rgb similarity and depth similarity
                                       depth_order=2,
                                       train_a=True,       # lambda trainable
    ...
    def training(self, epoch):
        ...
        for i, (image, dep, target) in enumerate(self.trainloader):
            ...
            outputs = [outputs[1]]                                                         # only use the PAM output
