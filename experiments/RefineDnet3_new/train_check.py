...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/RefineDnet3_new/results/config.yaml'
...
parser.add_argument('--att_type', type=str, default=None, help='Attention type to fuse rgb and dep')
parser.add_argument('--att_type2', type=str, default=None, help='Attention type to for multi-scale fusion')
parser.add_argument('--n_cbr', type=int, default=1, help='num of cbr modules in Attention AT2')
parser.add_argument('--with_bn', action='store_true', default=False, help='whether to use bn in multi-scale attention')
settings = parser.parse_args([])
print(settings)

settings.att_type2 = 'AT3'
# configuration
...
model = get_segmentation_model(args.model, dataset=args.dataset, backbone=args.backbone, pretrained=True,
                               ...
                               att_type=settings.att_type,
                               att_type2=settings.att_type2, n_cbr=settings.n_cbr, with_bn = settings.with_bn
                                       )
