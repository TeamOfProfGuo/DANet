...
def main():
    # output folder
    outdir = './results/deeplab_resnet50/out'
    ...
    model = get_segmentation_model(args.model, dataset=args.dataset,
                                   ...
                                   os=args.os, no_deepstem=args.no_deepstem)

    # load model params
    if args.model_path is not None and os.path.isfile(args.path):
    ...
    validate(args, model, testloader)
