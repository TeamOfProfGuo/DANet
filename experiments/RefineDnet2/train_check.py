...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/RefineDnet2/results/config.yaml'
...
parser.add_argument('--fuse_type', type=str, default='Type2', help='Use Attention to fuse rgb and dep: Fuse Type')
settings= parser.parse_args([])
print('settings attention:{} attention type:{} fuse type:{}'.format(settings.with_att, settings.att_type, settings.fuse_type))

settings.with_att = True
# configuration
